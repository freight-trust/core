...
contract("ERA gas test", function (accounts) {
  ...
  async function tests(eraInterface) {
    ...
    let result = await eraInterface.addUpdateDomain(
      testDomainHash1,
      testAuthAddress1,
      testOrgInfoAddress1,
      domainOwner
    ...
    console.log(
      "add domain (auth, domainInfo, domainOwner) First Write: " +
        result.receipt.gasUsed
    );
    result = await eraInterface.addUpdateDomain(
      testDomainHash1,
      testAuthAddress1,
      testOrgInfoAddress1,
      domainOwner,
    ...
    console.log(
      "add domain (auth, domainInfo, domainOwner) Subsequent Writes: " +
        result.receipt.gasUsed
    );
    ...
    console.log(
      "add domain (none) Subsequent Writes: " + result.receipt.gasUsed
    );
    ...
    console.log(
      "add domain (auth) Subsequent Writes: " + result.receipt.gasUsed
    );
    ...
    console.log(
      "add domain (domainInfo) First Write: " + result.receipt.gasUsed
    );
    result = await eraInterface.addUpdateDomain(
      testDomainHash1,
      DONT_SET,
    ...
    console.log(
      "add domain (domainInfo) Subsequent Writes: " + result.receipt.gasUsed
    );
    ...
    console.log(
      "add domain (domainOwner) First Write: " + result.receipt.gasUsed
    );
    result = await eraInterface.addUpdateDomain(
      testDomainHash1,
      DONT_SET,
    ...
    console.log(
      "add domain (domainOwner) Subsequent Writes: " + result.receipt.gasUsed
    );
    ...
    result = await eraInterface.removeDomain(testDomainHash1);
    console.log(
      "removeDomain (when domain not in use): " + result.receipt.gasUsed
    );
