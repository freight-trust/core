...
module.exports = {
  ...
  dumpAllDomainAddUpdateEvents: async function (eraInterface) {
    console.log(
      "ContractAddress                                 Event           BlkNum DomainHash                 AuthorityAddress             OrgAddress                OwnerAddress"
    );
    await eraInterface
      .DomainAddUpdate({}, { fromBlock: 0, toBlock: "latest" })
  ...
  assertDomainAddUpdateEventNum: async function (
    eraInterface,
    expectedNumEvents
  ) {
    eraInterface
