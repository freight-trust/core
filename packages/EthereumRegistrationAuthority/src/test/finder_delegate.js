...
const AbstractERA = artifacts.require(
...
contract("Finder: Delegate", function (accounts) {
  ...
  async function setupEras() {
    ...
    await eraInterface1.addUpdateDomain(
      testDomainHashP3,
      eraAddress2,
      common.DONT_SET,
      domainOwner
    );
    await eraInterface2.addUpdateDomain(
      testDomainHashP2,
      eraAddress3,
      common.DONT_SET,
      domainOwner
    );
    await eraInterface3.addUpdateDomain(
      testDomainHashP1,
      eraAddress4,
      common.DONT_SET,
      domainOwner
    );
    await eraInterface4.addUpdateDomain(
      testDomainHash,
      common.DONT_SET,
