...
contract("Domain Info gas test", function (accounts) {
  ...
  async function tests(domainInfoInterface) {
    ...
    const TWO_WORDS =
      "0x01020304050606708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F20";
    // 33 to 64 bytes are stored in three words: length word + 64 data bytes in two words.
    const THREE_WORDS =
      "0x01020304050606708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F2021";
    // 65 to 96 bytes are stored in four words: length word + 96 data bytes in three words.
    const FOUR_WORDS =
      "0x01020304050606708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728292A2B2C2D2E2F303132333435363738393A3B3C3D3E3F4041";

    // ECC public key. Note that this will be interpreted as a byte array.
    const EC_PUBLIC_KEY =
      "0x04855c7b3f9089fb5c7c3055497f2585c80af2cd22861cec172582fb097853172346c0c3accc3d53aab7a7bc27d03adb72fe0190ee73e13124e8554e76d7364018";
    ...
    console.log(
      "gas: setVale 1 word, initial write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, ONE_WORD);
    console.log(
      "gas: setVale 1 word, subsequent write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, ONE_WORD);
    console.log(
      "gas: setVale 1 word, subsequent write: " + receipt.receipt.gasUsed
    ...
    console.log(
      "gas: setVale 2 words, initial write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, TWO_WORDS);
    console.log(
      "gas: setVale 2 words, subsequent write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, TWO_WORDS);
    console.log(
      "gas: setVale 2 words, subsequent write: " + receipt.receipt.gasUsed
    ...
    console.log(
      "gas: setVale 3 words, initial write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, THREE_WORDS);
    console.log(
      "gas: setVale 3 words, subsequent write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, THREE_WORDS);
    console.log(
      "gas: setVale 3 words, subsequent write: " + receipt.receipt.gasUsed
    ...
    console.log(
      "gas: setVale 4 words, initial write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, FOUR_WORDS);
    console.log(
      "gas: setVale 4 words, subsequent write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, FOUR_WORDS);
    console.log(
      "gas: setVale 4 words, subsequent write: " + receipt.receipt.gasUsed
    ...
    console.log(
      "gas: setVale EC_PUBLIC_KEY, initial write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, EC_PUBLIC_KEY);
    console.log(
      "gas: setVale EC_PUBLIC_KEY, subsequent write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, EC_PUBLIC_KEY);
    console.log(
      "gas: setVale EC_PUBLIC_KEY, subsequent write: " + receipt.receipt.gasUsed
    ...
    console.log(
      "gas: setVale ENODE, initial write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, ENODE);
    console.log(
      "gas: setVale ENODE, subsequent write: " + receipt.receipt.gasUsed
    );
    receipt = await domainInfoInterface.setValue(key, ENODE);
    console.log(
      "gas: setVale ENODE, subsequent write: " + receipt.receipt.gasUsed
  ...
  it("DomainInfo deployement", async function () {
    ...
    let receipt = await web3.eth.getTransactionReceipt(
      domainInfoInstance.transactionHash
    );
