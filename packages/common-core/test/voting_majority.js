...
contract("Voting: majority voting tests:", function (accounts) {
  ...
  it("two participants: only one votes yes", async function () {
    ...
    assert.equal(
      isParticipant,
      false,
      "Majority did not vote yes. Unexpectedly, New Participant: isUnmaskedBlockchainParticipant != false"
    );
  });
  ...
  it("three participants: two vote yes", async function () {
    ...
    assert.equal(
      isParticipant,
      true,
      "Majority voted yes. Unexpectedly, New Participant: isUnmaskedBlockchainParticipant == false"
    );
  });
