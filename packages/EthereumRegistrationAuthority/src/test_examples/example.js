...
const ERAInterface = artifacts.require(
  "./EthereumRegistrationAuthorityInterface.sol"
);
...
contract("Example", function (accounts) {
  ...
  let allDomainsEmailAddressKeyHash = web3.utils.keccak256(
    "*:tech.pegasys.contact.email"
  );
  let allDomainsEnodeKeyHash = web3.utils.keccak256("*:ef.enode");
  let a1AaSuplyComEnodeKeyHash = web3.utils.keccak256(
    "a1.aa.supply.com:ef.enode"
  );
  let a2AaSuplyComEnodeKeyHash = web3.utils.keccak256(
    "a2.aa.supply.com:ef.enode"
  );
  ...
  async function setupAndDeployExampleComAndSubdomains() {
    ...
    await delegateEraExampleCom.addUpdateDomain(
      domainHashS1ExampleCom,
      common.DONT_SET,
      domainInfoS1ExampleCom.address,
      common.DONT_SET,
      { from: ownerExampleCom }
    );
    // s2.example.com: There is no delegate ERA for sub-domains. The owner of the sub-domain is the same as the ERA owner.
    await delegateEraExampleCom.addUpdateDomain(
      domainHashS2ExampleCom,
      common.DONT_SET,
      domainInfoS2ExampleCom.address,
      common.DONT_SET,
      { from: ownerExampleCom }
    );
    // example.com: Is listed in both Root ERA A and B. There is no domain info contract for example.com.
    await rootEraA.addUpdateDomain(
      domainHashExampleCom,
      delegateEraExampleCom.address,
      common.DONT_SET,
      ownerExampleCom,
      { from: ownerRootEraA }
    );
    await rootEraB.addUpdateDomain(
      domainHashExampleCom,
      delegateEraExampleCom.address,
      common.DONT_SET,
      ownerExampleCom,
    ...
    await domainInfoS1ExampleCom.setValue(
      allDomainsEmailAddressKeyHash,
      "admin@example.com",
      { from: ownerExampleCom }
    );
    await domainInfoS1ExampleCom.setValue(
      allDomainsEnodeKeyHash,
      "enode://10018a80d14311c39f35f516fa664deaaaa13e85b2f7493f37f6144d86991ec012937307647bd3b9a82abe2974e1407241d54947bbb39763a4cac9f77166ad92a0@10.3.58.6:30303?discport=30301",
      { from: ownerExampleCom }
    );
    await domainInfoS2ExampleCom.setValue(
      allDomainsEmailAddressKeyHash,
      "admin@example.com",
      { from: ownerExampleCom }
    );
    await domainInfoS2ExampleCom.setValue(
      allDomainsEnodeKeyHash,
      "enode://10028a80d14311c39f35f516fa664deaaaa13e85b2f7493f37f6144d86991ec012937307647bd3b9a82abe2974e1407241d54947bbb39763a4cac9f77166ad92a0@10.3.58.6:30303?discport=30301",
      { from: ownerExampleCom }
    );
  }
  ...
  async function setupAndDeployBankCoUk() {
    ...
    await rootEraB.addUpdateDomain(
      domainHashBankCoUk,
      common.DONT_SET,
      domainInfoBankCoUk.address,
      ownerBankCoUk,
      { from: ownerRootEraB }
    );

    // Add some information to the domain info contract.
    await domainInfoBankCoUk.setValue(
      allDomainsEmailAddressKeyHash,
      "admin@bank.co.uk",
      { from: ownerBankCoUk }
    );
    await domainInfoBankCoUk.setValue(
      allDomainsEnodeKeyHash,
      "enode://10118a80d14311c39f35f516fa664deaaaa13e85b2f7493f37f6144d86991ec012937307647bd3b9a82abe2974e1407241d54947bbb39763a4cac9f77166ad92a0@10.3.58.6:30303?discport=30301",
      { from: ownerBankCoUk }
    );
  }
  ...
  async function setupAndDeploySupplyComAndSubdomains() {
    ...
    await delegateEraSupplyCom.addUpdateDomain(
      domainHashAaSupplyCom,
      delegateEraSupplyCom.address,
      common.DONT_SET,
      common.DONT_SET,
      { from: ownerSupplyCom }
    );
    ...
    // Add some information to the domain info contracts.
    await domainInfoAaSupplyCom.setValue(
      allDomainsEmailAddressKeyHash,
      "admin@supply.com",
      { from: ownerSupplyCom }
    );
    await domainInfoAaSupplyCom.setValue(
      a1AaSuplyComEnodeKeyHash,
      "enode://10218a80d14311c39f35f516fa664deaaaa13e85b2f7493f37f6144d86991ec012937307647bd3b9a82abe2974e1407241d54947bbb39763a4cac9f77166ad92a0@10.3.58.6:30303?discport=30301",
      { from: ownerSupplyCom }
    );
    await domainInfoAaSupplyCom.setValue(
      a2AaSuplyComEnodeKeyHash,
      "enode://10228a80d14311c39f35f516fa664deaaaa13e85b2f7493f37f6144d86991ec012937307647bd3b9a82abe2974e1407241d54947bbb39763a4cac9f77166ad92a0@10.3.58.6:30303?discport=30301",
      { from: ownerSupplyCom }
    );
  }
  ...
  async function setupAndDeployEduAuAndSubdomains() {
    ...
    await delegateEraEduAu.addUpdateDomain(
      domainHashUqEduAu,
      delegateEraUqEduAu.address,
      common.DONT_SET,
      ownerUqEduAu,
      { from: ownerEduAu }
    );
    // itee.uq.edu.au: There is no delegate ERA for sub-domains.
    await delegateEraUqEduAu.addUpdateDomain(
      domainHashIteeUqEduAu,
      common.DONT_SET,
      domainInfoIteeUqEduAu.address,
      ownerIteeUqEduAu,
      { from: ownerUqEduAu }
    );
    ...
    // Add some information to the domain info contracts.
    await domainInfoIteeUqEduAu.setValue(
      allDomainsEmailAddressKeyHash,
      "admin@itee.uq.edu.au",
      { from: ownerIteeUqEduAu }
    );
    await domainInfoIteeUqEduAu.setValue(
      allDomainsEnodeKeyHash,
      "enode://10318a80d14311c39f35f516fa664deaaaa13e85b2f7493f37f6144d86991ec012937307647bd3b9a82abe2974e1407241d54947bbb39763a4cac9f77166ad92a0@10.3.58.6:30303?discport=30301",
      { from: ownerIteeUqEduAu }
    );
  }
