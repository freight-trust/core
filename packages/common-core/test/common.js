...
const CrosschainCoordinationV1 = artifacts.require(
  "./CrosschainCoordinationV1.sol"
);
...
const CrosschainCoordinationInterface = artifacts.require(
  "./CrosschainCoordinationInterface.sol"
);
...
const PUBLIC_KEY =
  "";
const KEY_VERSION = "1";
...
module.exports = {
  ...
  getNewCrosschainCoordination: async function () {
    let instance = await CrosschainCoordinationV1.new(
  ...
  dumpAllDump1Events: async function (anInterface) {
    console.log(
      "ContractAddress                                 Event           BlkNum DomainHash                 val1             val2                val3"
    );
    await anInterface
      .Dump1({}, { fromBlock: 0, toBlock: "latest" })
